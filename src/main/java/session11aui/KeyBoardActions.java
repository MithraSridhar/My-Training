...
public class KeyBoardActions {
	...
	action.keyDown(Keys.CONTROL).click(item1).click(item3).click(item5).click(item7).keyUp(Keys.CONTROL).build().perform();
	Thread.sleep(3000);
	action.keyDown(Keys.ARROW_DOWN).click(item1).click(item3).click(item5).click(item7).keyUp(Keys.CONTROL).build().perform();
